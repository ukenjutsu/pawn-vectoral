...
public:
	static cell AMX_NATIVE_CALL vector(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL capacity(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL reserve(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL g_capacity(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL g_reserve(AMX* amx, cell* params);
