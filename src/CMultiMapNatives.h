...
#include <string>
using namespace std;
class CMultiMapNatives{
public:
	static cell AMX_NATIVE_CALL l_multimap(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL count(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL count_float(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL count_int(AMX* amx,cell* params);
	...
	static cell AMX_NATIVE_CALL set_key_int(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL set_key_int_arr(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL set_key_int_float(AMX* amx,cell* params);

	static cell AMX_NATIVE_CALL set_key_float(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL set_key_float_arr(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL set_key_float_float(AMX* amx,cell* params);
	...
	/* Global */
	static cell AMX_NATIVE_CALL g_multimap(AMX* amx, cell* params);
	...
	static cell AMX_NATIVE_CALL g_count(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_count_float(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_count_int(AMX* amx,cell* params);
	...
	static cell AMX_NATIVE_CALL g_set_key_int(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_set_key_int_arr(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_set_key_int_float(AMX* amx,cell* params);

	static cell AMX_NATIVE_CALL g_set_key_float(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_set_key_float_arr(AMX* amx,cell* params);
	static cell AMX_NATIVE_CALL g_set_key_float_float(AMX* amx,cell* params);
